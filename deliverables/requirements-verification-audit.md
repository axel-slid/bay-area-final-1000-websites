...
| Do not have a website | PARTIAL / HEURISTIC | OSM/search heuristic used; 40 confirmed owned-site rows were removed. Not legal-proof or exhaustive. | `build-tools/confirmed-owned-site-removals.csv; build-tools/final-owned-site-audit-hits.csv` |
...
| Live deployment of deliverables | PROVED | Live Vercel site and deliverable URLs have been verified repeatedly; latest local deploy bundle has 11 deliverable files. | `https://bay-area-final-1000-websites.vercel.app/` |
