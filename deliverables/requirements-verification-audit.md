...
| Link Yelp/Booksy/profile if available | PARTIAL / AUDITED | 682 rows have accepted profile links. Audit: {'ACCEPTED - profile link in final CSV': 682, 'ATTEMPTED - no high-confidence profile found': 315, 'ATTEMPTED - search error': 3}. | `build-tools/profile-link-search-audit.csv` |
...
- Profile-link audit counts: {'ACCEPTED - profile link in final CSV': 682, 'ATTEMPTED - no high-confidence profile found': 315, 'ATTEMPTED - search error': 3}
- Profile-image audit counts: {'ACCEPTED - profile image embedded': 330, 'ATTEMPTED - no safe matching image found': 322, 'NO PROFILE LINK - category image used': 318, 'ATTEMPTED - search error': 30}
