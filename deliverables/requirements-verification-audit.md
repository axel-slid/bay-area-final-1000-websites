...
| Link Yelp/Booksy/profile if available | PARTIAL / AUDITED | 682 rows have accepted profile links. Audit: {'ACCEPTED - profile link in final CSV': 682, 'ATTEMPTED - no high-confidence profile found': 318}. | `build-tools/profile-link-search-audit.csv` |
...
- Profile-link audit counts: {'ACCEPTED - profile link in final CSV': 682, 'ATTEMPTED - no high-confidence profile found': 318}
- Profile-image audit counts: {'ACCEPTED - profile image embedded': 345, 'ATTEMPTED - no safe matching image found': 337, 'NO PROFILE LINK - category image used': 318}
- Confirmed owned-site removals recorded: 40
- Owned-website final-row audit counts: {'ATTEMPTED - no likely owned-site hit': 957, 'RAW HIT REVIEWED - not confirmed owned site': 43}
