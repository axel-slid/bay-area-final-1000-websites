...
- Owned-website search status for all 1000 final rows is documented in `owned-website-search-audit.csv`: 384 rows had no likely owned-site hit, 39 raw hits were reviewed but not confirmed as owned sites, and 577 rows had search-provider errors during the final audit. Confirmed owned-site removals remain recorded separately in `confirmed-owned-site-removals.csv`.
